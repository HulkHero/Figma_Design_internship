...
const Right = () => {
    return (
        <div className=' text-black relative self-center'>
            ...
            {/* <div style={{ zIndex: 1, backgroundImage: `url(${SVG})`, width: '400px', height: "500px" }} ></div> */}
            <div className='z-20 absolute top-[50%] left-[20%] transform -translate-x-[50%] -translate-y-[50%]  '>
                <div className='relative'>
                    ...
                    }} placeholder='Enter your email address..' className='px-4 min-w-[500px] h-[4.5rem]'></input>

                    <button className='absolute bottom-2 right-2 z-30 mt-[2.06rem] bg-button px-[2rem] py-[1rem] text-white rounded-[3.75rem]'>Contact Now</button>
                </div>
            </div>
        </div>
    )
