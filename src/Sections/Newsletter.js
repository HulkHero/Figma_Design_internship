...
import Left from '../Components/Newsletter/Left'
import Right from '../Components/Newsletter/Right'
    ...
    return (
        <section className='pl-[2%] my-36 rounded-[4.68rem] bg-blueLight  w-[92%] mx-[4%]'>
            <div className='flex relative  flex-row justify-between items-center ' >
                <Left></Left>
                <Right></Right>
                <div className='absolute -bottom-8 -left-14 -z-10  bg-[#FFF5DB] rounded-bl-[6.6rem] w-[8rem] h-[8rem]' ></div>
